...
import 'package:egerecords/widgets/products_sale_tile.dart';
...
class NewSale extends StatefulWidget {
  ...
  @override
  State<NewSale> createState() => __NewSaleStateState();
}

class __NewSaleStateState extends State<NewSale> {
      ...
      body: RefreshIndicator(
        ...
        child: hasInternet
          ...
          : ListView.builder(
                ...
                itemBuilder: (context, index) => ProductSaleTile(_products[index]),
              )
            : const Center(
...
class ProductsSearchDelegate extends SearchDelegate<Products> {
  ...
  Widget buildSuggestions(BuildContext context) {
    ...
    return ListView.builder(
      ...
      itemBuilder: (context, index) => ProductSaleTile(suggestions[index]),
    );
  }
